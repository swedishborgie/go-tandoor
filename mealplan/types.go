...
type MealPlan struct {
	...
	// FromDate is the start date/time of the meal plan entry.
	FromDate time.Time `json:"from_date,omitempty"`

	// ToDate is the end date/time of the meal plan entry.
...
type MealType struct {
	...
	Time      string `json:"time"`  // JSON time string, e.g. "12:00:00"
